...
extension CGDirectDisplayID {
    func getIOService() -> io_service_t {
        ...
        let kernResult = IOServiceGetMatchingServices(kIOMainPortDefault, matching, &serialPortIterator)
...
extension NSScreen {
    ...
    func getScreenNumber() -> NSNumber {
        let n = self.deviceDescription[NSDeviceDescriptionKey(rawValue: "NSScreenNumber")] as? NSNumber
        return n ?? -1
    }
